    ...
    <form id="edit-form" class="form-horizontal" method="post" action="{{$url}}">
        <div class="box-body">
            ...
            @if(Auth::guard('admin')->check())
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 show-status-box">
                        <label>
                            <input type="radio" name="show_status" class="minimal-checkbox" value="{{Brand::STATUS_ACTIVE}}"{{$brand->show_status == Brand::STATUS_ACTIVE ? ' checked="checked"' : ''}}>
                            <span>{{trans('admin.base.label.active')}}</span>
                        </label>
                        <label>
                            <input type="radio" name="show_status" class="minimal-checkbox" value="{{Brand::STATUS_INACTIVE}}"{{$brand->show_status == Brand::STATUS_INACTIVE ? ' checked="checked"' : ''}}>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="instagram" class="form-control" value="{{$brand->instagram or ''}}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="pinterest" class="form-control" value="{{$brand->pinterest or ''}}">
