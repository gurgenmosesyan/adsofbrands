        ...
        <div class="box-body">
            ...
            @if(Auth::guard('admin')->check())
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="checkbox" name="blocked" class="minimal-checkbox" value="{{Agency::BLOCKED}}"{{$agency->blocked == Agency::BLOCKED ? ' checked="checked"' : ''}}>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="instagram" class="form-control" value="{{$agency->instagram or ''}}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="pinterest" class="form-control" value="{{$agency->pinterest or ''}}">
